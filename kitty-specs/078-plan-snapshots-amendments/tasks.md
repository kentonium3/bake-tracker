...
## Work Package WP03: Amendment Service (Priority: P1) 🎯 MVP
...
### Included Subtasks
- [ ] T016 Add amendment controls panel frame to `src/ui/planning_tab.py`
...
```
WP01 (Model) → WP02 (Service+Hook)
                    ↓
              ┌─────┴─────┐
              ↓           ↓
        WP03 (Service) ∥ WP04 (UI)  [PARALLEL]
              └─────┬─────┘
                    ↓
             WP05 (Comparison)
```
