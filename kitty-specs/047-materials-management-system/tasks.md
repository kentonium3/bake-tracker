...
## Work Package WP01: Foundation - Material Models (Priority: P0) 🎯 MVP
...
## Work Package WP02: Catalog Service - User Story 1 (Priority: P1) 🎯 MVP
...
## Work Package WP03: Purchase Service - User Story 2 (Priority: P1) 🎯 MVP
...
## Work Package WP04: Material Units Service - User Story 3 (Priority: P1) 🎯 MVP
...
```
WP01 (Models) ──────┬──> WP02 (Catalog) ──┬──> WP03 (Purchases) ──> WP04 (Units) ──> WP05 (Composition)
                    │                      │                                              │
                    │                      └──────────────────────────────────────────────┼──> WP06 (Assembly)
                    │                                                                     │         │
                    └─────────────────────────────────────────────────────────────────────┼─────────┼──> WP07 (UI)
