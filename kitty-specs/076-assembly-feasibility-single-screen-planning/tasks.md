...
- [x] T009 [P] Test empty event and missing batch decisions
- [x] T010 [P] Test decision coverage metrics (decided_count vs total_fu_count)
...
- [x] T021 Wire callbacks: recipe save → FG save → batch save all trigger updates
