...
## Work Package WP03: FinishedGoodSnapshot Model + Service (Priority: P0) 🎯 MVP
...
- Component snapshot strategy:
  ...
  - `packaging_product_id` → skip (out of scope)
...
- **Sequence**: WP01 + WP02 (parallel) → WP03 → WP04
      ...
      └───┬────┘     └───┬────┘
          ...
          └──────┬───────┘
           ...
           └─────┬─────┘
                 │
           ┌─────▼─────┐
           │   WP04    │  ← Depends on WP01, WP02, WP03
           │(Planning) │
           └───────────┘
```
