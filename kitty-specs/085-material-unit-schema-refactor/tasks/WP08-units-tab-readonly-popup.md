...
- src/main.py
- src/ui/dialogs/material_product_popup.py
...
- 2026-01-30T18:44:31Z – claude-opus – shell_pid=45237 – lane=done – Review passed: Units tab read-only with info labels, Product column added, double-click opens MaterialProductPopup, no Add/Edit buttons
