...
### Risks & Mitigations
- Entity definitions may drift from actual models → validate against `src/models/` during implementation.

---

## Work Package WP02: Service Layer - Export Functions (Priority: P1) 🎯 MVP
...
### Risks & Mitigations
- Model field names may differ from spec → verify against actual SQLAlchemy models

---

## Work Package WP03: Service Layer - Import Functions with Mode Support (Priority: P1) 🎯 MVP
...
### Risks & Mitigations
- Replace mode data loss → implement confirmation requirement in UI (WP04)
- Foreign key violations → enforce strict dependency order

---

## Work Package WP04: UI - Menu Bar and Dialogs (Priority: P1) 🎯 MVP
...
### Risks & Mitigations
- Menu bar styling may not match CustomTkinter theme → accept native styling as per research
- Long operations may freeze UI → implement progress callback pattern
...
### Risks & Mitigations
- Sample data may not cover edge cases → include variety in test data
