...
## Work Package WP01: Fix Material Units Tab Query (Priority: P1) 🎯 MVP
...
### Risks & Mitigations
- Query performance with joins → Use eager loading with SQLAlchemy relationship

---

## Work Package WP02: Fix Edit/Delete Button Enablement (Priority: P1) 🎯 MVP
...
### Risks & Mitigations
- Root cause unknown → Start with debug logging before making changes
...
### Risks & Mitigations
- Floating point precision → Use round() for display, exact values for storage
...
### Included Subtasks
- [ ] T009 Detect linear product and conditionally show unit dropdown
...
- Get base_unit_type: MaterialProduct → Material.base_unit_type
...
### Risks & Mitigations
- Complex dialog state → Keep UI logic simple, delegate math to service
