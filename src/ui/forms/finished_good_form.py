...
from src.models.finished_good import FinishedGood, YieldMode
...
class FinishedGoodFormDialog(ctk.CTkToplevel):
    """
    Dialog for creating or editing a finished good.
    ...
    def __init__(
        ...
        title: str = "Add Finished Good",
    ):
        """
        Initialize the finished good form dialog.

        Args:
            parent: Parent window
            finished_good: Existing finished good to edit (None for new)
            title: Dialog title
        """
