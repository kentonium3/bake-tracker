...
def get_feature_artifacts(feature_dir: Path, project_dir: Optional[Path] = None) -> Dict[str, Dict[str, any]]:
    ...
    Args:
        feature_dir: Path to the feature directory (e.g., kitty-specs/001-feature/)
        project_dir: Path to the project root. If provided, constitution is checked
                     at project level (.kittify/memory/constitution.md) rather than
                     feature level.
    """
    ...
    if project_dir is not None:
        ...
        # Fallback for backwards compatibility (though this path is typically wrong)
